...
//   // Efek scroll untuk mengubah posisi navbar menjadi fixed
//   useEffect(() => {
//     const handleScroll = () => {
//       setIsScrolled(window.scrollY > 50); // Fixed jika scroll > 50px
//     };
...
//   return (
//     <nav
//       className={`w-full bg-[#00423b]  transition-all duration-300 ${
//         isScrolled
//           ? "fixed top-0 left-0 bg-[#14b8a6] shadow-lg z-50"
//           : "relative"
//       }`}
//     >
...
//         {/* Desktop Menu */}
//         <div className="hidden lg:flex space-x-4 rounded-2xl">
//           {tabs.map((tab) => (
            ...
            <button
              ...
              className={`px-7 py-2 cursor-pointer transition-all duration-300 flex items-center space-x-2
                ${
                  activeTab === tab.name
                    ? "underline text-[#14b8a6] underline-offset-8"
                    : "hover:underline hover:text-[#14b8a6] underline-offset-8"
                }`}
            >
              <tab.icon size={18} />
              <span>{tab.name}</span>
        ...
        {/* {tabs.map((tab) => (
          <button
            ...
            className={`font-inter bg-[#00423b] px-5 py-2 border-b flex items-center space-x-2 border-gray-700 last:border-none hover:bg-gray-800
              ${
                activeTab === tab.name
                  ? "underline text-[#14b8a6] bg-[#00423b]"
                  : "hover:underline"
              }`}
          >
            <tab.icon size={18} />
