...
export default function ProjectsSection() {
  ...
  return (
    <section
      ref={ref}
      id="projects"
      className="bg-[#00423b] flex justify-between flex-col items-center lg:flex-row lg:items-stretch gap-10 lg:gap-20 my-8 lg:my-32 text-sm md:text-base lg:min-w-[600px]"
    >
      <div>
